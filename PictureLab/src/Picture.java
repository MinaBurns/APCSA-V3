...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorGulls()
  {
	  ...
	  for(int col = 243; col<mirrorPoint; col++)
	  {
  ...
  {
    Picture flower1 = new Picture("C:\\Users\\burnsc6389\\Desktop\\APCSA-V3\\Unit16\\pixLab\\images\\flower1.jpg");
    Picture flower2 = new Picture("C:\\Users\\burnsc6389\\Desktop\\APCSA-V3\\Unit16\\pixLab\\images\\flower2.jpg");
    ...
    this.mirrorVertical();
    this.write("C:\\Users\\burnsc6389\\Desktop\\APCSA-V3\\Unit16\\pixLab\\images\\collage.jpg");
  }
  ...
  public void encode(Picture image)
  {
	  Pixel[][] currPixels = this.getPixels2D();
	  Pixel[][] messagePixels = image.getPixels2D();
	  ...
	  for (int row = 0; row < this.getHeight(); row++)
	  {
		  for (int col = 0; col < this.getWidth(); col++)
		  {
			  ...
			  if (currPixel.getGreen() % 3 == 2)
			  {
				  currPixel.setGreen(currPixel.getGreen() - 1);
			  }
			  if (currPixel.getBlue()%3 == 2)
			  {
			  ...
			  {
				  if(currPixel.getGreen()%3==1)
				  {
					  currPixel.setGreen(currPixel.getGreen() + 1);
				  }
				  else if(currPixel.getGreen()%3==0)
				  {
  ...
  public void decode()
  {
	  ...
	  for (int row = 0; row < this.getHeight(); row++)
	  {
		  for (int col = 0; col < this.getWidth(); col++)
		  {
			 ...
			 // messagePixel = messagePixels[row][col];
			  if ((currPixel.getGreen() % 3 == 2) && (currPixel.getBlue() % 3 == 2) && (currPixel.getRed() % 3 == 2))
			  {
